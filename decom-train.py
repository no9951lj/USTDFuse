...
for epoch in range(num_epochs):
    ...
    for vis_imgs, ir_imgs in zip(train_loader_vis , train_loader_ir ):
        ...
        # print(recon_loss1)
        # print(l1_loss1)
        # print(gradient_loss1,gradient_loss2)
        # total_loss = 100*vgg_loss + recon_loss1 + recon_loss2+0.0000001*(gradient_loss1+gradient_loss2+l1_loss1+0.01*l1_loss2)  +gradient_loss1+gradient_loss2
        total_loss = 10*vgg_loss + recon_loss1 + recon_loss2 + 0.1*(0.000001 * (l1_loss1 )+ 0.0000004 *l1_loss2+0.0000001*(gradient_loss1+gradient_loss2))
...
torch.save(checkpoint, 'decom-DATFuse.pth')