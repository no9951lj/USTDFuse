...
IR_files = sorted(get_img_file(r"./train_data/DATFuse/train/ir"))
VIS_files   = sorted(get_img_file(r"./train_data/DATFuse/train/vi"))

assert len(IR_files) == len(VIS_files)
h5f = h5py.File(os.path.join('./train_data',
...
with h5py.File(os.path.join('./train_data',
